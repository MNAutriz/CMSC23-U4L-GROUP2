...
class DonationDrivesPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final donations = Provider.of<DonationProvider>(context).donations; // Ensure donations are accessible here
    ...
    return Scaffold(
      ...
      body: ListView.builder(
        ...
        itemBuilder: (context, index) {
          // Filter donations based on the drive, this is just a placeholder
          final driveDonations = donations.where((donation) => donation.driveDetails != null && donation.driveDetails!.contains('Drive ${index + 1}')).toList();
          ...
          return DonationDriveCard(
            ...
            donations: driveDonations, // Pass the list of donations for this drive
          );
        },
      ),
