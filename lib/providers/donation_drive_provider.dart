...
class DonationDriveProvider with ChangeNotifier {
  ...
  // hiniwalay ko muna yung providers at api nalilito kasi me hahaha -Kervin
  ...
  Future<String> addDonationDrive(Map<String, dynamic> drive) async {
    return firebaseService.addDonationDrive(drive);
  }

  Future<String> deleteDonationDrive(String id) async {
    return firebaseService.deleteDonationDrive(id);
  }

  Future<String> editDonationDrive(String id, Map<String, dynamic> updatedDrive) {
    return firebaseService.editDonationDrive(id, updatedDrive);
  }
}
